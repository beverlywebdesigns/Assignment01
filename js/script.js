...
alert('Hello ' + myName + ' ' + lastName + ', welcome to the JavaScript class!')
*/
...
/*
let course = 'Hello Zak Ruvalcaba.\nWelcome to the JavaScript class!'
alert(course)
*/
...
// STEP 16. Replace the hardcoded string of the class you are taking with a prompt 
...
// STEP 20. Declare a variable called x and assign it a value that equals 
...
//STEP 22. Using a set of Comparison and Logical operators, write an 
